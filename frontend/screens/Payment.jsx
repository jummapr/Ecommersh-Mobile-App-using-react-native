  ...
  const onlineHandler = async () => {
    try {
      ...
      const init = await stripe.initPaymentSheet({
        ...
        merchantDisplayName: "Jumma-Ecom.com",
      });
      ...
      <RadioButton.Group
        ...
        >
          <View style={styles.radioStyles}>
            <Text style={styles.radioStylesText}>Cash On Delivery</Text>
            <RadioButton color={colors.color_1} value={"COD"} />
          </View>
          <View style={styles.radioStyles}>
            <Text style={styles.radioStylesText}>ONLINE</Text>
            <RadioButton color={colors.color_1} value={"ONLINE"} />
          </View>
        </RadioButton.Group>
      </View>
